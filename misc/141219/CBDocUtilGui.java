...
public class CBDocUtilGui extends JFrame {
	...
	JTextField viewName = new JTextField("View Name");
	JTextField desgnDoc = new JTextField("Design Doc");
  ...
  */      
	...
	private class  ALQueryExecute implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			String viewName = me.viewName.getText();
	...
	private class VCListBoxViewResult implements ListSelectionListener {
		...
		public void valueChanged(ListSelectionEvent e) {
			...
			if (lsm.isSelectionEmpty()) {
			  ...
			  System.out.println("Selected row = "+minIndex+" isAdjusting  "+isAdjusting);
		    }        
